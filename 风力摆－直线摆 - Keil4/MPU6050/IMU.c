...
#define Kp 10.6f                        // proportional gain governs rate of convergence to accelerometer/magnetometer
#define Kpn 0.2f
...
//  float q1q2 = q1*q2;
  ...
  q3 = q3 / norm;
	...
	angle->rol = -atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2* q2 + 1)* 57.3 - AngleOffset_Rol - 0.8; // roll
}
